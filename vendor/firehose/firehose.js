...
(function() {
  ...
  Firehose.LongPoll = (function(superClass) {
    extend(LongPoll, superClass);
    ...
    LongPoll.prototype._success = function(data, status, jqXhr) {
      var e, last_sequence, message, ref;
...
(function() {
  ...
  Firehose.WebSocket = (function(superClass) {
    ...
    WebSocket.supported = function() {
      return ((typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? global : window).WebSocket != null;
    };
    ...
    WebSocket.prototype._request = function() {
      var err;
      try {
        this.socket = new ((typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? global : window).WebSocket((this._protocol()) + ":" + this.config.uri + "?" + ($.param(this.config.params)));
...
(function() {
  Firehose.version = "1.2.20";

  Firehose.codeName = "Onprogress of Doom";
